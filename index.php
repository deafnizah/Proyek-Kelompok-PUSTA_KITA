...
<html lang="en">
  ...
  <div class="container-fluid">
    <img src="assets/logoNavPusta.png" alt="logo" width="120px">
    ...
    <section id="homeSection" class="p-5">
      <div class="d-flex flex-wrap justify-content-center">
        <div class="col mt-5">
         <h2 class="fw-bold text-success"><span class="text-primary">Pusta</span>Kita</h2>
          <p class="mb-4">"Temukan Dunia Pengetahuan di Ujung Jari Anda: <br> Perpustakaan Online <span class="fw-bold">PustaKita</span> Membawa Anda ke Dunia Buku Digital."</p>
    ...
    <footer id="footer" class="p-3 bg-dark">
      <div class="row">
        <div class="col">
          <img src="assets/logoFooterPusta.png" width="200px">
        </div>
      </div>
      <div class="row p-3">
        <div class="col mt-3">
